ifneq ($(filter $(HOST_ARCH), andes),)

TOOLCHAIN_PATH ?=
ifneq ($(filter $(HOST_MCU_FAMILY), mv_p20xx), )
TOOLCHAIN_PREFIX := nds32le-elf-
TOOLCHAIN_DEFAULT_FOLDER := nds32le-elf-mculib-v3
#TOOLCHAIN_PREFIX := arm-none-eabi-
#TOOLCHAIN_DEFAULT_FOLDER := arm-none-eabi-5_4-2016q3-20160926
endif


$(info  in aos_toolchain_andes.mk )
...
DOWNLOAD_URL   = "https://github.com/chenyuiop/ardunio/raw/master/download/1.6.4/nds32le-elf-mculib-v3m.zip"
TOOLCHIAN_FILE = "not surport"
...
DOWNLOAD_URL   = "https://github.com/chenyuiop/AliOS/raw/master/andes_toolchains/Linux/nds32le-elf-mculib-v3.txz"
TOOLCHIAN_FILE = "nds32le-elf-mculib-v3.txz"
$(error can not find compiler toolchain, please download $(TOOLCHIAN_FILE) from $(DOWNLOAD_URL) and unzip to $(TOOLS_ROOT)/compiler/arm-none-eabi-$(TOOLCHAIN_VERSION)/$(HOST_OS) folder)
endif
endif
...
#$(info  SYSTEM_GCC_PATH = $(SYSTEM_GCC_PATH) )
...
ADD_COMPILER_SPECIFIC_STANDARD_CFLAGS   = $(1) -Wall -mcmodel=medium # -Wfatal-errors -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu99 # $(if $(filter yes,$(MXCHIP_INTERNAL) $(TESTER)),-Werror)
...
ifeq ($(HOST_ARCH),andes)
CPU_BASE_FLAGS     := -mcpu=n968a -mlittle-endian  -mcmodel=medium
...
OBJCOPY_BIN_FLAGS   := -S -O binary #-R .eh_frame -R .init -R .fini -R .comment  
