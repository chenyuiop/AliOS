...
void board_init(void)
{
    ...
    hal_partitions[HAL_PARTITION_APPLICATION].partition_length           = 0x000F0000;    //960k bytes
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_1].partition_start_addr       = 0x000F0000;
    hal_partitions[HAL_PARTITION_PARAMETER_1].partition_length           = 0x008000; // 32k bytes
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_2].partition_start_addr       = 0x000F8000;
    hal_partitions[HAL_PARTITION_PARAMETER_2].partition_length           = 0x008000; //32k bytes
    ...
    hal_partitions[HAL_PARTITION_OTA_TEMP].partition_start_addr          = 0x00100000;
    hal_partitions[HAL_PARTITION_OTA_TEMP].partition_length              = 0x000F0000; //960k bytes
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_3].partition_start_addr       = 0x001F0000;
    hal_partitions[HAL_PARTITION_PARAMETER_3].partition_length           = 0x8000; //32k bytes
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_4].partition_start_addr       = 0x001F8000;
    hal_partitions[HAL_PARTITION_PARAMETER_4].partition_length           = 0x8000; //32k bytes
